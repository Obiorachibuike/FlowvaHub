            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 text-left">
                ...
                <div className="relative">
                    <div className="flex justify-between items-center mb-2">
                        ...
                        <Link href="/forgot-password" className="text-[10px] font-bold text-[#8b31ff] hover:underline">Forgot Password?</Link>
                    </div>
                    <div className="relative">
                ...
                <button type="submit" disabled={isLoading} className="w-full bg-[#8b31ff] text-white font-bold py-3.5 rounded-xl text-xs hover:brightness-110 transition-all shadow-lg shadow-purple-200 mt-2 disabled:opacity-50">
