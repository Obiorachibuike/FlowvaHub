            ...
            <header className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
                ...
                <div className="flex items-center space-x-4">
                    <Link href="/login">
                     ...
                     <Link href="/login">
                        <Button className="text-sm font-semibold bg-gray-900 text-white rounded-full">Sign up</Button>
                    </Link>
                </div>
            </header>

            <div className="max-w-4xl mx-auto text-center mt-16 px-6">
                <div className="inline-flex bg-gray-100 p-1 rounded-full mb-12 shadow-inner">
                    <button 
                        onClick={() => setActiveTab('users')}
                        className={`${activeTab === 'users' ? 'bg-gray-800 text-white shadow-lg' : 'text-gray-500'} px-5 py-2 rounded-full text-xs font-bold flex items-center transition-colors`}
                    >
                        <span className="mr-2 opacity-70">👥</span> For users
                    </button>
                    <button 
                        onClick={() => setActiveTab('brands')}
                        className={`${activeTab === 'brands' ? 'bg-gray-800 text-white shadow-lg' : 'text-gray-500'} px-5 py-2 rounded-full text-xs font-bold flex items-center transition-colors`}
                    >
